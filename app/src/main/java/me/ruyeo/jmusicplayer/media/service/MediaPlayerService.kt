package me.ruyeo.jmusicplayer.media.service
...
import me.ruyeo.jmusicplayer.R
import me.ruyeo.jmusicplayer.media.Constants
import me.ruyeo.jmusicplayer.media.exoplayer.MediaPlayerNotificationManager
import me.ruyeo.jmusicplayer.media.exoplayer.MediaSource
...
class MediaPlayerService : MediaBrowserServiceCompat() {
    ...
    override fun onCustomAction(
        ...
        when (action) {
            ...
            Constants.STAR_MEDIA_PLAY_ACTION -> {
                mediaPlayerNotificationManager.showNotification(exoPlayer)
            }
